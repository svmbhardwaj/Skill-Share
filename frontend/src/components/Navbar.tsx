    ...
    return (
        <nav className={`${styles.navbar} ${isScrolled ? styles.scrolled : ''}`}>
            <div className={styles.container}>
                <Link href="/" className={styles.logo} aria-label="SkillShare — home">
                    ...
                    <span className={styles.wordmark}>
                        <span>Skill</span><span className={styles.brandText}>Share</span>
                    </span>
                </Link>
                ...
                <div className={styles.navLinks}>
                    ...
                    {isAuthenticated ? (
                        <>
                            ...
                            <Link href="/my-services" className={`${styles.navLink} ${router.pathname === '/my-services' ? styles.active : ''}`}>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            ...
                            <Link href="/post-service" className={styles.postServiceBtn}>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className={`${styles.mobileMenu} ${isMobileMenuOpen ? styles.open : ''}`}>
                <Link href="/browse" onClick={() => setIsMobileMenuOpen(false)}>Browse Services</Link>
                {isAuthenticated ? (
                    <>
                        <Link href="/my-jobs" onClick={() => setIsMobileMenuOpen(false)}>My Jobs</Link>
                        <Link href="/my-services" onClick={() => setIsMobileMenuOpen(false)}>My Services</Link>
                        <Link href="/post-service" onClick={() => setIsMobileMenuOpen(false)}>Post a Service</Link>
