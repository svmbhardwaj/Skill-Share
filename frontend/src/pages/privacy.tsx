                ...
                <div className={styles.container}>
                    ...
                    <section className={styles.section}>
                        ...
                        <ul>
                            ...
                            <li><strong>Service Information:</strong> Details about services you post or request.</li>
                    ...
                    <section className={styles.section}>
                        ...
                        <p>
                            ...
                            Razorpay (for payments). These services have their own privacy policies, and we encourage you 
                            to review them.
                        </p>
                    </section>
